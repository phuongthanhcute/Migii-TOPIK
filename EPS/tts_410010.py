...
async def text_to_speech(text, voice, output_path, rate="+0%", pitch="+0Hz"):
    ...
    try:
        ...
        # SỬA LỖI: Truyền cả rate và pitch vào Communicate
...
async def process_file(input_file, male_rate, male_pitch, female_rate, female_pitch):
...
async def main():
    ...
    # Xử lý file đầu vào
    await process_file(input_file, male_rate, male_pitch, female_rate, female_pitch)
